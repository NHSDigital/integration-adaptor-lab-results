...
class WorkflowIdTest {
    ...
    void testFromStringReturnsWorkflowIdForValidWorkflowIdString() {
        assertAll(() -> {
            assertEquals(WorkflowId.PATHOLOGY, WorkflowId.fromString(WorkflowId.PATHOLOGY.getWorkflowId()));
            assertEquals(WorkflowId.PATHOLOGY_ACK, WorkflowId.fromString(WorkflowId.PATHOLOGY_ACK.getWorkflowId()));
            assertEquals(WorkflowId.SCREENING, WorkflowId.fromString(WorkflowId.SCREENING.getWorkflowId()));
            assertEquals(WorkflowId.SCREENING_ACK, WorkflowId.fromString(WorkflowId.SCREENING_ACK.getWorkflowId()));
        });
    }
