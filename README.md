...
Important: If the MESH mailbox uses workflows other than `PATH_MEDRPT_V3`, `PATH_MEDRPT_V3_ACK`, `SCRN_BCS_MEDRPT_V4` and `SCRN_BCS_MEDRPT_V4_ACK` then these messages must be
